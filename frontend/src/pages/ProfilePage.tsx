import { BellIcon, BookOpenIcon, CaretRightIcon, ChartBarIcon, ClockCounterClockwiseIcon, FireIcon, GearSixIcon, LockKeyIcon, MoonStarsIcon, PencilSimpleIcon, QuestionIcon, SignOutIcon, StepsIcon, TrophyIcon } from '@phosphor-icons/react'
