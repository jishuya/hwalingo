...
const masteryLabels = ['처음 만남', '기억 시작', '단기 기억', '익숙함', '장기 기억 진입', '장기 기억', '마스터', '완전 마스터']
